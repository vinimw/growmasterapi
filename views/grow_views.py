...
from utils import fetch_external_data, post_external_data, build_request_params, build_request_params_post, build_request_params_patch, patch_external_data
