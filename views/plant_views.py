...
from utils import fetch_external_data, post_external_data, build_request_params, build_request_params_post, build_request_params_delete, delete_external_data
...
@plant_bp.route('/api/plants/delete', methods=['POST'])
@token_required
async def delete_plant():
    ...
    url, headers = build_request_params_delete('plants', id)
